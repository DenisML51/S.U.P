...
let decryptJson: (encryptedPayload: string, payloadIv: string, payloadTag: string) => unknown;
let encryptJson: (value: unknown) => { encryptedPayload: string; payloadIv: string; payloadTag: string };
